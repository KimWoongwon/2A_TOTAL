...
ElfFactory::ElfFactory()
{
	...
	PossiblePetList[count++] = new CharacterFactory::Pet("나무정령");
	PossiblePetList[count++] = new CharacterFactory::Pet("물정령");
	PossiblePetList[count++] = new CharacterFactory::Pet("바람정령");
	PossiblePetList[count++] = new CharacterFactory::Pet("불정령");
}
ElfFactory::~ElfFactory()
{
